...
export class Circle implements Shape {
  ...
  name: string
  readonly points: Record<"center" | "radius", Point>
  readonly refs: Record<"center" | "radius", string>
  readonly edges: Record<never, EdgeReferenceDefinition> = Circle.emptyEdges
